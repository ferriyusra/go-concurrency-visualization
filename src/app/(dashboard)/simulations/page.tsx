...
export default function SimulationsPage() {
	return (
		<div className='max-w-7xl mx-auto p-6'>
			<div className='mb-8'>
				<h1 className='text-3xl font-bold'>Go Concurrency Visualization</h1>
				<p className='text-muted-foreground mt-2'>
					Interactive simulation that teaches Go concurrency patterns through a
					real cinema scenario. See the Go code alongside a live visualization.
				</p>
			</div>
